...
export const DEFAULT_GALLERY_CATEGORIES: GalleryCategoryItem[] = [
  ...
  { id: 'cat-hospedaje', slug: 'hospedaje', name: 'Hospedaje Campestre', display_order: 4, is_active: true, is_default: true },
...
export const FALLBACK_GALLERY_ITEMS: GalleryItemRow[] = [
  ...
  },
  {
    ...
    raffle_id: null,
    title: 'Vuelo en el Cañón',
    category: 'parapente',
    image_slug: 'parapente-tandem-canon',
    image_url: null,
    alt_text: 'Vuelo biplaza seguro con instructor certificado en el cañón de Manaure',
    display_order: 10,
    is_active: true,
    created_at: '2026-09-20T00:00:00Z',
    updated_at: '2026-09-20T00:00:00Z',
