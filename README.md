...
6. **Fuente Canónica de Verdad de Migraciones:**
   La carpeta `supabase/migrations/` (archivos `001_initial_schema.sql` a `036_gallery_categories.sql`) constituye la **única fuente de verdad histórica y evolutiva**.
