...
│   └── migrations/             # Migraciones SQL estructuradas (001 a 040) con políticas RLS
│
...
6. **Fuente Canónica de Verdad de Migraciones:**
   La carpeta `supabase/migrations/` (archivos `001_initial_schema.sql` a `040_enable_realtime_for_operational_tables.sql`) constituye la **única fuente de verdad histórica y evolutiva**.
