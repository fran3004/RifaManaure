...
│   └── migrations/             # Migraciones SQL estructuradas (001 a 041) con políticas RLS
│
...
6. **Fuente Canónica de Verdad de Migraciones:**
   La carpeta `supabase/migrations/` (archivos `001_initial_schema.sql` a `041_storage_cleanup_and_integrity_hardenings.sql`) constituye la **única fuente de verdad histórica y evolutiva**.
